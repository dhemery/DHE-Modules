...
public:
  ...
  explicit BlossomPanel(rack::engine::Module *module) {
    ...
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::SpeedCvInput));
    ...
    y += dy;
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::RatioCvInput));
    ...
    y += dy;
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::DepthCvInput));
    ...
    y += dy;
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::PhaseCvInput));
    addParam(
    ...
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::XGainCvInput));
    ...
    addOutput(Jack::output<BlossomPanel>(
        module, column4, y + output_port_offset, Controls::XOutput));

    y += dy;
    addInput(
        Jack::input<BlossomPanel>(module, column1, y, Controls::YGainCvInput));
