...
namespace xycloid {
  ...
  public:
    explicit XycloidPanel(rack::engine::Module *module) {
      ...
      addParam(Toggle::stepper(2, slug, module, column4, y, Controls::FreeRatioSwitch));
      ...
      addParam(Toggle::stepper(3, slug, module, column4, y, Controls::DirectionSwitch));
      ...
      addParam(Toggle::stepper(2, slug, module, column3, y, Controls::XRangeSwitch));
      addOutput(Jack::output(slug, module, column4, y + outputPortOffset, Controls::XOutput));
      ...
      addParam(Toggle::stepper(2, slug, module, column3, y, Controls::YRangeSwitch));
      addOutput(Jack::output(slug, module, column4, y + outputPortOffset, Controls::YOutput));
    }
  };
} // namespace xycloid
} // namespace dhe
