...
Port *Port::create(rack::Module *module, std::string module_name, rack::Port::PortType type, int index, rack::Vec center) {
...
Knob *Knob::create(rack::Module *module, std::string module_name, std::string size, int index, rack::Vec center, float initial) {
...
Button *Button::create(rack::Module *module, std::string module_name, std::string type, int index, rack::Vec center) {
