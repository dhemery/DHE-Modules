...
void registerModel(const std::string &name, TTag... tags) {
  ...
  rack::Model *model = rack::Model::create<TModule, TPanel, TTag...>(
      "DHE-Modules", slug, name, tags...);
...
void init(rack::Plugin *p) {
  ...
  registerModel<DHE::BoosterStage, DHE::BoosterStagePanel>(
      "Booster Stage", rack::ENVELOPE_GENERATOR_TAG);
  registerModel<DHE::Cubic, DHE::CubicPanel>("Cubic",
                                             rack::FUNCTION_GENERATOR_TAG);
