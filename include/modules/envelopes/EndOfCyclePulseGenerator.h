...
public:
  EndOfCyclePulseGenerator(std::function<void()> onEocRise,
                           std::function<void()> onEocFall)
      : PhaseAccumulator{[]() { return oneMillisecond; }, std::move(onEocRise),
                         [](float) {}, std::move(onEocFall)} {}
};
} // namespace dhe
