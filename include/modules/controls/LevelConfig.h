 ...
 */
void configLevelKnob(rack::engine::Module const *module, int knobId, Range const &range,
 ...
 */
void configLevelKnob(rack::engine::Module const *module, int knobId, int switchId, std::string const &name = "Level",
                     float initialRotation = centeredRotation);

/**
 * Configures the param and display for a level range switch.
 */
void configLevelRangeSwitch(rack::engine::Module const *module, int switchId, std::string const &name = "Level Range",
                            int initialState = 1);
} // namespace dhe
