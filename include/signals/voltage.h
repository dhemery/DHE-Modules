...
static auto constexpr range_count = 2;
static auto ranges = std::array<Range, range_count>{bipolar_range, unipolar_range};
static auto constexpr labels = std::array<char const *, range_count>{"±5 V", "0–10 V"};
