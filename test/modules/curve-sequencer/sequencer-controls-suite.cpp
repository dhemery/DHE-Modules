...
public:
  ...
  void register_tests(dhe::unit::TestRegistrar add) override {
    ...
    add("is_looping()", test([](Tester &t, Module &module, Controls &controls) {
          module.set_param(Controls::Param::Loop, 1.F);
          module.set_input(Controls::Input::Loop, 0.F);
          t.assert_that("button pressed", controls.is_looping(), is_true);

          module.set_param(Controls::Param::Loop, 0.F);
          module.set_input(Controls::Input::Loop, 10.F);
    ...
    add("is_reset()", test([](Tester &t, Module &module, Controls &controls) {
          module.set_param(Controls::Param::Reset, 1.F);
          module.set_input(Controls::Input::Reset, 0.F);
          t.assert_that("button pressed", controls.is_reset(), is_true);

          module.set_param(Controls::Param::Reset, 0.F);
          module.set_input(Controls::Input::Reset, 10.F);
    ...
    add("is_running()", test([](Tester &t, Module &module, Controls &controls) {
          module.set_param(Controls::Param::Run, 1.F);
          module.set_input(Controls::Input::Run, 0.F);
          t.assert_that("button pressed", controls.is_running(), is_true);

          module.set_param(Controls::Param::Run, 0.F);
          module.set_input(Controls::Input::Run, 10.F);
    ...
    add("selection_start()",
        test([](Tester &t, Module &module, Controls &controls) {
          ...
          module.set_param(Controls::Param::SelectionStart, start);
    ...
    add("selection_length()",
        test([](Tester &t, Module &module, Controls &controls) {
          ...
          module.set_param(Controls::Param::SelectionLength, length);
    ...
    add("input()", test([](Tester &t, Module &module, Controls &controls) {
          ...
          module.set_input(Controls::Input::In, input);
    ...
    add("output()", test([](Tester &t, Module &module, Controls &controls) {
          ...
          module.set_output(Controls::Output::Out, output);
