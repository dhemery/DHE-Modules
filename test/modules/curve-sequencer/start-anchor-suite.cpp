...
public:
  ...
  void register_tests(TestRegistrar add) override {
    add("after enter(s) with AnchorSource::In: "
        ...
        test([](Tester &t, Controls &controls, StartAnchor &anchor) {
          auto constexpr step = 2;
          controls.start_anchor_mode_[step] = AnchorMode::Snap;
          controls.start_anchor_source_[step] = AnchorSource::In;
          ...
          controls.start_anchor_source_[step] = AnchorSource::Level;
          t.assert_that("with AnchorSource::Level", anchor.voltage(),
                        is_equal_to(initial_input_voltage));

          controls.start_anchor_source_[step] = AnchorSource::Out;
    ...
    add("with AnchorMode::Track: "
        ...
        test([](Tester &t, Controls &controls, StartAnchor &anchor) {
          ...
          controls.start_anchor_mode_[step] = AnchorMode::Track;
...
__attribute__((unused)) static auto _ = StartAnchorSuite{};
