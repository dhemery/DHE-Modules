#include "modules/curve-sequencer-2/StepSelector2.h"
...
namespace curve_sequencer {
  namespace step_selector {
    ...
    using dhe::curve_sequencer::StepSelector2;
    ...
    TEST_CASE("curve_sequencer::StepSelector2") {
      FakeControls controls{};
      StepSelector2<FakeControls> selector{controls, stepCount};
