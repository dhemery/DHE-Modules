 ...
 */
static inline void configCurvatureKnob(rack::engine::Module *module, int knobId, std::string const &name = "Curvature",
 ...
 */
static inline void configCurveShapeSwitch(rack::engine::Module *module, int switchId, std::string const &name = "Shape",
                                          int initialState = 0) {
