...
namespace tapers {
  ...
  public:
    explicit TapersPanel(rack::engine::Module *module) {
      ...
      y += dy;
      addParam(Toggle::stepper(2, slug, module, column1, y, Controls::ShapeSwitch1));
      addParam(Toggle::stepper(2, slug, module, column2, y, Controls::LevelRangeSwitch1));
      ...
      y += dy;
      addParam(Toggle::stepper(2, slug, module, column1, y, Controls::ShapeSwitch2));
      addParam(Toggle::stepper(2, slug, module, column2, y, Controls::LevelRangeSwitch2));
