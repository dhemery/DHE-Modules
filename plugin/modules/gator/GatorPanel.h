  ...
  public:
    explicit GatorPanel(rack::engine::Module *module) {
      ...
      for (auto i = 0; i < Controls::inputCount / 2; i++) {
        ...
        addParam(Toggle::button(slug, module, lc, y, Controls::NegateButtons + i));
        addParam(Toggle::button(slug, module, rc, y, Controls::NegateButtons + i + Controls::inputCount / 2));
        addInput(Jack::input(slug, module, right, y, Controls::Inputs + i + Controls::inputCount / 2));
        y += dy;
      }
