...
namespace cubic {
  ...
  public:
    CubicPanel(rack::engine::Module *module) {
      ...
      addInput(Jack::input(slug, module, column1, y, Controls::ACoefficientCvInput));
      addParam(Knob::small(slug, module, column2, y, Controls::ACoefficientKnob));

      y += dy;
      addInput(Jack::input(slug, module, column1, y, Controls::BCoefficientCvInput));
      addParam(Knob::small(slug, module, column2, y, Controls::BCoefficientKnob));

      y += dy;
      addInput(Jack::input(slug, module, column1, y, Controls::CCoefficientCvInput));
      addParam(Knob::small(slug, module, column2, y, Controls::CCoefficientKnob));

      y += dy;
      addInput(Jack::input(slug, module, column1, y, Controls::DCoefficientCvInput));
      ...
      addInput(Jack::input(slug, module, column2, y, Controls::OutputGainCvInput));
