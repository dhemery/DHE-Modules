...
(0..last_row).each do |row|
  ...
  pick_list x: right_center, y: y, name: 'offset-range', options: %w[0–5 ±5 0–10 ±10], selection: 2, width: 7
  pick_list x: right_center, y: y, name: 'multiplier-range', options: %w[0–1 ±1 0–2 ±2], selection: 2, width: 7, hidden: true
