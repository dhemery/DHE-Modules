...
(0..last_row).each do |row|
  ...
  stepper x: right_center, y: y, name: 'addend-range', options: %w[0–5 ±5 0–10 ±10], selection: 2, width: 7
  stepper x: right_center, y: y, name: 'multiplier-select', options: %w[0–1 ±1 0–2 ±2], selection: 2, width: 7, hidden: true
